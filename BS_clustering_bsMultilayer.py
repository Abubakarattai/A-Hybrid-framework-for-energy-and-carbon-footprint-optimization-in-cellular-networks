...
#for n_sc in [8, 12, 16, 20, 24, 36, 48, 60, 72, 84, 96, 108, 120]:
for n_sc in [120]:
#for n_sc in [96]:
    ...
    for path_sc in tqdm(os.listdir(file_name_sc)):
        ...
        #for row in [102]:
            ...
            for index_i, i in enumerate(storage_index):
                ...
                if traffic_index[index_i]<=1:
                    storage_energy.append(power_module(tuple(i), row, traffic_index[index_i])[0])
                else:
